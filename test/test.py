...
class QRePSResultTest(unittest.TestCase):
    ...
    def test_qreps(self):
        ...
        with TemporaryDirectory() as tmpdir:
            args = argparse.Namespace(sample_file=os.path.join(datadir, 'a172_dbtrg_sample.csv'), labels=['DBTRG_I,DBTRG_K','A172_I,A172_K'], input_dir=datadir, output_dir=tmpdir, imputation='kNN', thresholds='dynamic', regulation='UP', pattern = '_protein_groups.tsv', species = '9606', fold_change=2, alpha=0.01, fasta_size = 20417)
